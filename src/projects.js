    ...
    offers: [
      {
        ...
        emoji: "🧭",
        title: "1:1 코칭",
        tagline: "아이디어는 있는데, 코드 앞에서 막힌 분께.",
        who: "비개발자 · 기획자 · 1인 사업가 — 만들고 싶은 서비스가 있는 분",
        points: [
          "AI 바이브코딩(Claude Code 등)으로 기획 → 개발 → 배포까지 전 과정 안내",
          "배포·DB·결제·에러처럼 막히는 지점을 화상으로 함께 실시간 해결",
          "내 아이디어에 맞는 스택·구조를 같이 설계",
        ],
...
export const PROJECTS = [
  ...
  },
  {
    ...
    slug: "brain",
    emoji: "🧠",
    description: "고령층 본인이 하루 10분, 인지 훈련 게임·회상치료·가족 참여로 치매를 예방하는 두뇌 활동 플랫폼.",
    ...
    detail: {
      ...
      coverCaption: "매일 두뇌 활동 — 홈(연속 훈련·오늘의 게임)",
  ...
  },
  {
    ...
    detail: {
      ...
      coverCaption: "펫포토 AI — 랜딩(히어로 + 실제 생성 샘플 갤러리)",
      ...
      summary: [
        ...
        "여기서 한 걸음 더 나아가, 같은 저장소에 설치형 데스크톱판 '펫포토 AI 스튜디오'를 하나 더 만들었습니다. 소비자용 웹은 그대로 두고, 펫샵·동물병원이 매장에서 손님에게 서비스로 쓰는 B2B 도구로 방향을 튼 두 번째 제품이에요. 구매자가 자기 구글 Gemini 키를 넣어 무제한으로 쓰고, 손님 사진은 우리 서버를 거치지 않고 PC에서 곧장 처리됩니다. Electron으로 exe 설치본을 만들어 2026년 7월 크몽에 판매 등록(심사 중)했습니다 — 스탠다드 29,000원부터, 한 번 사면 계속 쓰는 프로그램 판매 방식.",
      ],
      features: [
        ...
        "설치형 데스크톱판(펫포토 AI 스튜디오) — 같은 렌더러를 Electron exe로 재사용, 펫샵·동물병원용 B2B 상품(크몽 판매). 여러 마리 배치 처리 + 가게 로고 워터마크(canvas)",
