...
export const PROJECTS = [
  {
    ...
    detail: {
      // ⚠️ 로컬 레포를 못 찾아 대부분 초안 — 실제 날짜/스택 확인해 채우기
      summary: [
        "발달·재활이 필요한 아이를 키우는 부모에게, 흩어진 정보 대신 '바로 쓰는 자료'를 건네고 싶었습니다. 25년차 치료사의 노하우를 전자책과 도구로 묶어 파는 온라인 책방입니다.",
        "결제 후 바로 내려받는 디지털 커머스라, 재고 없이 콘텐츠 자체가 상품이 되는 1인 운영 구조로 만들었습니다.",
      ],
      features: [
        "전자책 카탈로그 — 주제별 분류와 상세 페이지",
        "디지털 상품 결제 → 즉시 다운로드",
        "부모를 위한 도구·키트 안내",
      ],
      // 초안 — 실제 스택 확인 필요
      ...
      // 초안 — 직접 작성
      challenges: [
        "(초안) 디지털 상품 결제 후 다운로드 권한을 어떻게 안전하게 줄지.",
        "(초안) 전문 콘텐츠를 5060 부모도 쉽게 찾도록 카테고리를 어떻게 짤지.",
      ],
      prompts: [
        { title: "(초안) 상품 데이터 모델", text: "여기에 실제로 썼던 핵심 프롬프트를 적어 주세요. 예: 전자책 상품을 카탈로그/상세/결제까지 잇는 데이터 모델을 설계해줘." },
      ],
      retro: [
        "(초안) 운영하며 느낀 점을 직접 적어 주세요.",
      ],
    },
  },
  {
