...
export const ME = {
  ...
  about: [
    ...
    "문법을 외우는 대신 '무엇을 왜 만들지'에 집중합니다. 전자책 커머스부터 헬스케어 SaaS, AI 분석 리포트, 공인중개사 플랫폼, 복지 지원사업 검색, 언어치료 앱, 음성 회의록 데스크톱 앱, 시니어 치매 예방 훈련까지 — 혼자 기획하고, 만들고, 운영하는 1인 개발 실험을 이어갑니다.",
  ...
  // ────────────────────────────────────────────────────────────
  contact: {
    formUrl: "https://tally.so/r/b5EKOL",   // Tally — 1:1 코칭·외주 문의 폼
