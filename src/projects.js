...
export const PROJECTS = [
  ...
  },
  {
    ...
    slug: "petphoto",
    emoji: "🐾",
    description: "반려동물 사진 한 장을 올리면 AI가 8가지 스타일의 프로필 사진으로 만들어 주는 서비스.",
    url: "https://pet-photo-ai.vercel.app",
    status: "live",
    tags: ["반려동물", "AI 이미지", "Vite"],
    ...
    detail: {
      ...
      stack: ["React 19", "TypeScript", "Vite 7", "Tailwind CSS v4", "Supabase(Postgres·Storage)", "Toss Payments", "Gemini(gemini-3-pro-image)", "sharp", "Vercel Serverless Functions", "Vercel Cron"],
      timeline: [
