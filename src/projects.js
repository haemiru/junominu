...
export const ME = {
  ...
  about: [
    ...
    "문법을 외우는 대신 '무엇을 왜 만들지'에 집중합니다. 전자책 커머스부터 헬스케어 SaaS, AI 분석 리포트, 공인중개사 플랫폼, 복지 지원사업 검색, 언어치료 앱, 음성 회의록 데스크톱 앱까지 — 혼자 기획하고, 만들고, 운영하는 1인 개발 실험을 이어갑니다.",
  ...
  now: [
    ...
    "중개프로 — 정기결제 연동까지 끝내고 공인중개사 올인원 SaaS의 정식 출시를 준비하는 중",
  ...
  },
  {
    ...
    detail: {
      ...
      summary: [
        ...
        "그 반복을 한 화면에서 끝내자는 게 중개프로의 시작입니다. 매물·계약서·CRM·문의·실거래가 시세 조회를 하나로 묶고, 중개사무소마다 자기 서브도메인으로 독립된 공간을 갖는 멀티테넌트 SaaS로 만들고 있습니다. 첫 커밋부터 5개월, 200커밋을 넘기며 국토부 실거래가 실데이터·검색 지도 보기에 이어 토스 정기결제까지 붙여 정식 출시를 준비하는 베타입니다.",
      ],
      // 핵심 기능 (실제 구현 기준)
      features: [
        "매물 관리 — 유형별 동적 폼·상태(거래중/완료) 자동 전환·상세 검색(금액/면적/등록일)·사진",
        "국토부 실거래가 — 단지별 실거래 실데이터로 주변 시세·분석(캐싱·출처 표시)",
        ...
        "구독 SaaS — 토스 정기결제(빌링) + Free/유료 플랜별 기능 제어·잠금 메뉴 업그레이드 유도",
  ...
  },
  {
    ...
    detail: {
      ...
      features: [
        ...
        "치료실 찾기 — 전국 소아재활·전자바우처 제공기관 지도(Leaflet+OSM), VWorld 좌표 2,270곳, 목록/지도 토글",
      ...
      challenges: [
        ...
        "카카오맵 지오코딩이 반려돼, VWorld API로 우회해 전국 치료실 2,270곳의 좌표를 확보했습니다.",
  ...
  },
  {
    ...
    detail: {
      ...
      summary: [
        ...
        "녹음·영상 파일을 올리면 faster-whisper가 전사하고, 로컬 LLM(qwen)이 회의록·인터뷰·강의 형식으로 정리해 바로 쓰는 Word 문서로 내보냅니다. 진짜 차별점은 '회사 양식 업로드' — 쓰던 docx 양식을 올리면 그 서식 그대로 칸을 채워 줍니다. 구독이 아니라 한 번 사서 계속 쓰는 설치형 프로그램이고, 크몽 일회 라이선스로 판매를 준비하는 베타입니다.",
      ],
      features: [
