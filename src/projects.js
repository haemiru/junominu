...
export const ME = {
  ...
  // 히어로 아래 대비 밴드 — 이 계정의 반전 훅을 그대로 화면으로 옮긴 것.
  // 🔴 히어로에 프로젝트 화면을 진열하지 않는다(사용자 지적 2026-08-03).
  //    간판은 상품 진열장이 아니다. 프로젝트는 바로 아래 PROJECTS 에서 본다.
  //    「예전 / 지금」의 낙차야말로 이 사이트에만 있는 것이고, 그게 간판이 된다.
  //    오른쪽 숫자(개월·개수)는 since 와 PROJECTS 길이로 자동 계산된다.
  contrast: {
    beforeLabel: "IT 회사 22년 동안",
    beforeN: 0,
    afterLabel: "AI 바이브 코딩 {n}개월 동안",   // {n} = since 로부터 경과 개월
    note: "내 손으로 만든 서비스",
  },
