...
export const ME = {
  ...
  intro: "비개발자가 AI 코딩으로 기획·개발·운영까지 혼자 해내는 1인 메이커의 작업실.",
  ...
  about: [
    "저는 원래 개발자가 아닙니다. 기획하고 사업을 굴리던 사람이, AI 코딩 — 흔히 '바이브 코딩(vibe coding)'이라 부르는 방식 — 으로 직접 제품을 만들기 시작했습니다.",
    "Claude Code와 Cursor 같은 AI 코딩 에이전트에게 아이디어를 말로 설명하면, 비개발자도 React·Next.js·Supabase로 진짜 동작하는 웹앱을 배포까지 할 수 있는 시대가 됐습니다. 이 작업실은 그 과정을 기록하는 곳입니다.",
    "문법을 외우는 대신 '무엇을 왜 만들지'에 집중합니다. 전자책 커머스부터 헬스케어 SaaS, AI 분석 리포트, 공인중개사 플랫폼까지 — 혼자 기획하고, 만들고, 운영하는 1인 개발 실험을 이어갑니다.",
  ],

  // Now — 지금 집중하는 일
  now: [
    "중개프로 — 공인중개사 올인원 SaaS의 멀티테넌트 구조를 다듬는 중",
    "킁킁메이트 — 호흡·후각 자가훈련 앱의 자동 리포트 개선",
    "이 사이트(junominu.com)를 바이브 코딩 작업 일지로 확장하는 중",
  ],
