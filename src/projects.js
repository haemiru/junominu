...
export const ME = {
  ...
  badge: "IT 회사 22년, 개발은 한 번도 안 해봤습니다",   // ← 반전(내가 누구인가)

  // 히어로 아래 큰 화면 한 장. 없으면 대표작(featured) 첫 번째의 cover/thumb 을 쓴다.
  // 🔴 "이 사람이 만든 게 이 정도구나"를 3초에 보여주는 자리다 — 제일 잘 나온 화면으로.
  heroShot: "/shots/jungaepro-cover.png",
  heroShotSlug: "jungaepro",
  heroShotAlt: "중개프로 — 공인중개사 올인원 업무 플랫폼 화면",
