...
- [ ] **Now 섹션**: "지금 만들고 있는 것" (주/월 단위 갱신)
- [ ] **지표 카운터**: 만든 프로젝트 수 / 운영 중 수 / 누적 일수 등
...
- [ ] About 섹션: 누구인지 + **왜** 바이브 코딩을 하는지(비개발자 → 1인 메이커 서사)
- [ ] 연락처 / SNS / GitHub 링크
...
- [ ] 데이터 모델 설계: `ME` 확장(소개·링크·지표), `PROJECTS` 상세 필드 스키마 확정
...
- [ ] **About 섹션** 추가 (4번)
- [ ] **지표 카운터** 추가 (2번) — 데이터에서 자동 계산(예: live 개수)
- [ ] **Now 섹션** 추가 (2번)
- [ ] **스택/도구함 섹션** 추가 (5번)
...
- **2026-06-01** — 로드맵 문서 생성(`ROADMAP.md` + `ROADMAP.html`). 콘텐츠 5영역 + Phase 0~4 정의. 다음: Phase 0 데이터 모델 설계 → Phase 1 착수.
