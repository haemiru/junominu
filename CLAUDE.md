...
- **블로그 글쓰기**: `.claude/skills/blog-post/SKILL.md` — 프로젝트 1개 → **글 1편(기본) 또는 2편**. 분량·이미지·FAQ·검증 규약이 전부 여기 있다. 짱샘의 책방 `/add-blog-and-reviews-to-ebook`을 이 사이트(정적 md·앱 캡처·짧은 분량)에 맞게 옮긴 것.
