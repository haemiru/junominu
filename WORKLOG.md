...
### 🧵 발행 대기 — 중개프로 스레드 1편 ← **여기부터**
- `drafts/2026-07-27-jungaepro-G-report.txt` (채점 91/100, 1편). 07-24 발행글의 **다음 회차** — 같은 공인중개사분, 이번 불편은 「손님한테 설명이 안 남는다」. 토픽 `#공인중개사`, 링크 `.../auth/signup?utm_campaign=jungaepro-report`.
